...
# generate_data = Generate_data('C:\\Users\\GODFREY\\Desktop\\projects\\Deep-Emotion-master\\Deep-Emotion-master\\dataset')
# # generate_data.split_test()
# generate_data.save_images('val')